...
/docs/{requirement,prd,userflow,database,common-modules,architecture,techstack}.md 문서를 읽고 프로젝트의 상태를 구체적으로 파악한다.
로그인(clerk)과 같이 외부 연동이 필요할 경우 /docs/external/clerk.md 파일을 참고한다. 
